...
public class GUITitleBar extends GUIComponent {
	...
	private Sprite closeSprite = new Sprite(buttons, 1, 0, 6);
	private Sprite moveSprite = new Sprite(buttons, 0, 0, 6);
	
	public GUITitleBar(GUIPanel panel, MouseMotionInput mouseMotionInput, Renderer graphics, int color) {
...
class CloseButton extends GUIButton {
	...
	public CloseButton(GUITitleBar titleBar, GameMouseListener mouseInput, Renderer graphics, Sprite_old sprite, int x, int width, int y) {
...
class MoveButton extends GUIButton {
	...
	public MoveButton(GUITitleBar titleBar, GameMouseListener mouseInput, Renderer graphics, Sprite_old sprite, int x, int width, int y) {
