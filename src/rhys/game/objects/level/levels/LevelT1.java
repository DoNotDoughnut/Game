...
class LevelT1Sprites extends Sprite {
	...
	private static SpriteSheet fountainSprites = new SpriteSheet("/rhys/game/resources/spritesheets/fountain_sprites.png", 16, Sprite.defaultSize);
	
	public LevelT1Sprites(int x, int y) {
		super(fountainSprites, x, y, 0);
	}
